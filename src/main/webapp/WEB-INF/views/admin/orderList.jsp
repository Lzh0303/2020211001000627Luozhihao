			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.luozhihao.model.Order o=(com.luozhihao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.luozhihao.dao.UserDao userDao=new com.luozhihao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.luozhihao.model.Payment.findByPaymentId(con,n);
							 %>
